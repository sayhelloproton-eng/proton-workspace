...
README 已经按时间讲清 2017～2026 发生了什么，这一篇不再重复年份，而是换一个角度：**每一次技术演进到底把什么新责任带进了软件系统。**
...
完整的复杂度升级与降级判断可继续读 [Agent 工程复杂度与边界](../Agent工程复杂度与边界.md)。下一篇则从最底层开始，解释模型本身为什么能够理解和生成文本。
